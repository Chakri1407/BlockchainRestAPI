...
const Wallet = require('../ Eagle-eyed observer! I notice there's a small typo in the file path you provided. It should be:

```javascript
const Wallet = require('../src/models/Wallet');
```

Let me correct that and provide the complete test file.

<xaiArtifact artifact_id="b1bd9f5d-70b6-4170-b5a1-b84a8de03c03" artifact_version_id="4a4bb3ee-5a1b-4bb3-858f-0cc191347ec4" title="tests/blockchain.test.js" contentType="text/javascript">
const request = require('supertest');
const app = require('../src/app');
const mongoose = require('mongoose');
const User = require('../src/models/User');
...
describe('Blockchain API', () => {
  ...
  describe('POST /api/blockchain/mine', () => {
    ...
    it('should mine a block successfully', async () => {
      ...
      expect(res.body.data.hash).toMatch(/^0000/); // Check proof-of-work
    });
  ...
  describe('GET /api/blockchain/status', () => {
    ...
    it('should get blockchain status successfully', async () => {
      ...
      expect(res.body.data).toHaveProperty('transactionCount', 2); // 1 funding + 1 transfer
